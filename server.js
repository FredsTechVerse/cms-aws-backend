...
const storage = multerS3({
  s3, //This is for securing the where.
  bucket: process.env.S3_BUCKET_NAME, //THis is for securing the bucket.
...
const upload = multer({
  storage: storage,
}); //It must be returning an object with a method as one of its props.
